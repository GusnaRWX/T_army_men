# TREASURY - ARMY
This project based on Next.JS, Redux Toolkit, Redux Saga and emotion
...
git clone https://gitlab.com/TreasuryApp/treasury-army.git
...
## Architecture
```
|-- client/ # this is current Next JS Directory
